...
namespace Org.Apache.REEF.Wake.Remote.Impl
{
    ...
    /// </summary>
    internal class RemoteConnectionRetryHandler : IConnectionRetryHandler
    {
        private static readonly Logger Logger = Logger.GetLogger(typeof(RemoteConnectionRetryHandler));
        private readonly int _retryCount;
        private readonly TimeSpan _timeIntervalInMs;
        private RetryPolicy<AllErrorsTransientStrategy> _retryPolicy;
            ...
            [Parameter(typeof(SleepTimeInMs))] int timeIntervalInMs)
        {
            ...
            _timeIntervalInMs = TimeSpan.FromMilliseconds(timeIntervalInMs);
            _retryPolicy = new RetryPolicy<AllErrorsTransientStrategy>(
                    new FixedInterval("ConnectionRetries", _retryCount, _timeIntervalInMs, true));
