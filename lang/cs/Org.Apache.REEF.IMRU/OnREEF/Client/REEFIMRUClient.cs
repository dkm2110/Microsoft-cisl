...
namespace Org.Apache.REEF.IMRU.OnREEF.Client
{
    ...
    internal sealed class REEFIMRUClient : IIMRUClient
    {
        ...
        IEnumerable<TResult> IIMRUClient.Submit<TMapInput, TMapOutput, TResult, TDataHandler>(IMRUJobDefinition jobDefinition)
        {
            ...
            var imruDriverConfiguration = TangFactory.GetTang().NewConfigurationBuilder(new[]
            {
                DriverConfiguration.ConfigurationModule
                    .Set(DriverConfiguration.OnEvaluatorAllocated,
                        GenericType<IMRUDriver<TMapInput, TMapOutput, TResult, TDataHandler>>.Class)
            ...
            var imruJobSubmission = _jobRequestBuilder
                ...
                .AddGlobalAssemblyForType(typeof(IMRUDriver<TMapInput, TMapOutput, TResult, TDataHandler>))
