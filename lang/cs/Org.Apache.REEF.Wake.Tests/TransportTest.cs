...
namespace Org.Apache.REEF.Wake.Tests
{
    public class TransportTest
    {
        ...
        private readonly ITcpClientFactory _tcpClientFactory = GetTcpClientFactory(5, 500);
        ...
        private static ITcpClientFactory GetTcpClientFactory(int connectionRetryCount, int sleepTimeInMs)
        {
            var config =
                TangFactory.GetTang()
                    ...
                    .Build();
            return TangFactory.GetTang().NewInjector(config).GetInstance<ITcpClientFactory>();
        }
    }
}
